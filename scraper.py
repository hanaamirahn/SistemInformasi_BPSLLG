...
Mengambil data dasar buku: judul, harga, rating, status stok, dan URL sumber.
Disimpan ke tabel `scraped_books` (independen dari fitur API).
"""
...
def scrape_books(pages=1):
    ...
    simpan ke tabel `scraped_books`. Return jumlah data yang berhasil disimpan.
    """
    total_saved = 0
    ...
    for page in range(1, pages + 1):
        ...
        for art in articles:
            ...
            db.insert_scraped_book(title, price, rating, availability, source_url)
            total_saved += 1
